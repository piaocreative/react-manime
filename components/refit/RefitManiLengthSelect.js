...
const RefitManiLengthSelect = ({ state, setState, onBack, onConfirm }) => {
        ...
        <div className={style.imageContainer}>
          <div className={classNames(style.imagePanel, style.alignRight)}>
            <div className={style.handCanvas}>
              ...
              <img
                src='/static/icons/feedback/some-right-hand.svg'
                style={{
                  position: 'absolute',
                  zIndex: 9,
                  right: 0,
          ...
          <div className={classNames(style.imagePanel, style.alignLeft)}>
            <div className={style.handCanvas}>
              ...
              <img
                src='/static/icons/feedback/some-left-hand.svg'
                style={{
                  position: 'absolute',
                  zIndex: 9,
                  left: 0,
                ...
                alt='some-left' />
              <map name='leftmap'>
                <area shape='circle' coords='136,22,16' alt='left-pinky' href='#' onClick={() => {log.info('0 clikced');onSelectFinger(0);}} />
                <area shape='circle' coords='170,48,16' alt='left-ring' href='#' onClick={() => {log.info('1 clikced');onSelectFinger(1)}} />
                <area shape='circle' coords='187,74,16' alt='left-middle' href='#' onClick={() => {log.info('2 clikced');onSelectFinger(2);}} />
                <area shape='circle' coords='175,105,16' alt='left-index' href='#' onClick={() => {log.info('3 clikced'); onSelectFinger(3);}} />
                <area shape='circle' coords='109,149,16' alt='left-thumb' href='#' onClick={() => {log.info('4 clikced');onSelectFinger(4);}} />
              </map>
            </div>
          </div>
        </div>
...
export default RefitManiLengthSelect;
