...
const SilverBubble = ({ selected, label, onClick }) => {
    ...
    <div>
      <svg
        ...
        <g transform="translate(0.751 1.031)">
          <defs>
            <linearGradient id="jb2ptg1h3a" x1="50%" x2="50%" y1="0%" y2="100%">
              <stop offset="0%" stopColor="#AEAEAE"/>
              <stop offset="66.694%" stopColor="#ECECEC"/>
              <stop offset="76.422%" stopColor="#F2F2F2"/>
              <stop offset="83.661%" stopColor="#E5E5E5"/>
              <stop offset="100%" stopColor="#B1B1B1"/>
            </linearGradient>
          </defs>
          <path
