...
const MultipleBubble = ({ selected, label, onClick }) => {
    ...
    <div>
      <svg
        ...
        <g transform="translate(0.751 1.031)">
          <defs>
            <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="multiple">
              <stop stopColor="#F4F090" offset="0%"></stop>
              <stop stopColor="#E2A3C7" offset="33.5709635%"></stop>
              <stop stopColor="#BC92F7" offset="55.4351028%"></stop>
              <stop stopColor="#A8D4FF" offset="81.9714544%"></stop>
              <stop stopColor="#ABE49A" offset="100%"></stop>
            </linearGradient>
          </defs>
          <path
